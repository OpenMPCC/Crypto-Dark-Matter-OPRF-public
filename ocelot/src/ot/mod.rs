...
//! * `endemic_ot`: an OT extension using Kyber as the underlying hard problem.
//!
...
pub type KosSender = kos::Sender<endemic_ot::Receiver>;
/// Instantiation of the KOS OT extension receiver, using Chou-Orlandi as the base OT.
pub type KosReceiver = kos::Receiver<endemic_ot::Sender>;
...
mod tests {
    ...
    #[test]
    fn test_endemic_ot(){
        test_ot::<endemic_ot::Sender, endemic_ot::Receiver>();
    }
